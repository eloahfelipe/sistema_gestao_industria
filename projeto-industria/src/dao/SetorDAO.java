...
public class SetorDAO {
    ...
    public Setor buscarPorId(Integer id) {
        try {
            String sql = "SELECT * FROM WHERE id_setor = ?;";
            ...
            if (rs.next()) {
                ...
                String nome = rs.getString("id_setor");
                String responsavel = rs.getString("id_setor");
                Setor setor = new Setor(id, nome, responsavel);
                return setor;
            }
    ...
    public Boolean atualizar(Setor setor) {
        try {
            ...
            int qtdeAtaulizacoes = ps.executeUpdate();

            if (qtdeAtaulizacoes > 0) {
                return true;
            }
